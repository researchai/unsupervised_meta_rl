...
from tests.fixtures.envs.dummy.dummy_box_pixel_env import DummyBoxPixelEnv
...
__all__ = [
    'DummyEnv', 'DummyBoxEnv', 'DummyBoxPixelEnv', 'DummyDictEnv',
    'DummyDiscrete2DEnv', 'DummyDiscreteEnv', 'DummyDiscretePixelEnv',
