...
def resume_task(*_):
    folder = 'src/data/local/ppo-push-multi-task/ppo_push_multi_task_2019_06_26_17_56_37_0001'
    from_epoch = 500
    with LocalRunner() as runner:
        goal_low = np.array((-0.1, 0.8, 0.02))
        goal_high = np.array((0.1, 0.9, 0.02))
        ...
        print('construting done')
        args = runner.restore(folder, env=envs, from_epoch=from_epoch)
