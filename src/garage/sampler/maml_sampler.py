"""MAMLSampler which uses ParallelVecEnvExecutor to run multiple environments."""
import itertools
import pickle
import time
...
class MAMLSampler(BatchSampler):
    ...
    def start_worker(self):
        ...
        self._vec_env = ParallelVecEnvExecutor(
            env=self.env, n=self._n_envs, max_path_length=self.algo.max_path_length)
