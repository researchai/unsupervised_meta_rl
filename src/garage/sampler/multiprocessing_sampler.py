...
def run_worker(factory, to_worker, to_sampler, worker_number, agent, env):
    ...
    """
    # When a python process is closing, multiprocessing Queues ttempt to flush
    ...
    # We call this here in case this process crashes (usually do to a bug or
    # out-of-memory error in the underlying worker).
