...
from garage.experiment import MetaEvaluator, Snapshotter, SnapshotConfig
    ...
    def test_one_folder(self, meta_train_dir, itrs):
        ...
        with LocalTFRunner(snapshot_config=snapshot_config) as runner:
            ...
            for itr in itrs:
                ...
                runner.sess = tf.compat.v1.Session()
                runner.__enter__()

                runner.restore(meta_train_dir, from_epoch=itr)
                meta_evaluator._test_sampler = runner.make_sampler(
                    LocalSampler,
                    n_workers=1,
                    max_path_length=self.max_path_length,
