...
class GaussianGRURegressorModel(GaussianGRUModel):
    """
    GaussianGRURegressor based on garage.tf.models.Model class.
    ...
    def __init__(self,
                 input_shape,
                 output_dim,
                 name='GaussianGRURegressorModel',
                 **kwargs):
    ...
    def network_output_spec(self):
        """Network output spec."""
        return [
            'means', 'log_stds', 'normalized_means', 'normalized_log_stds',
            'step_hidden', 'init_hidden', 'x_mean', 'x_std', 'y_mean', 'y_std', 'dist'
        ]
    ...
    def _build(self, state_input, step_input, hidden_input, name=None):
        ...
        (normalized_mean, _, normalized_log_std, _, _,
            hidden_init_var, dist) = super()._build(
            normalized_xs_var, step_input, hidden_input)
        ...
        return (means_var, log_stds_var, normalized_mean,
                normalized_log_std, _, _,
                x_mean_var, x_std_var, y_mean_var,
                y_std_var, dist)
